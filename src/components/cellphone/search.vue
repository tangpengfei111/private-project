  ...
  <div class="box">
    ...
    <el-dialog title="添加分组" :visible.sync="addGroupVisible" width='35%' top='17vh'>
        ...
        <el-form-item label="设备组描述">
            <el-input v-model="groupData.groupDescribe" autocomplete="off" height='200'></el-input>
        </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    addGroup() {
      ...
      if (this.groupData.cellphoneGroup) {
    ...
    callout(option) {
      ...
      if (option) {
        this.groupData = {
          'cellphoneGroup': option.cellphoneGroup,
          'groupDescribe': option.groupDescribe,
          'id': option.id
        }
      }
    }
