<template>
  <div class="box">
    <el-button v-if="flag" type="primary" size="small" @click="addGroupVisible = true">添加分组</el-button>
    ...
    <el-dialog title="删除提示" :visible.sync="delGroupVisible" width="30%" :show-close="false" top='30vh'>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="delGroup">取 消</el-button>
    ...
    <el-dialog title="添加分组" :visible.sync="addGroupVisible" width='35%' top='17vh'>
        <el-form :model="addGroupData">
        <el-form-item label="设备分组">
            <el-input v-model="addGroupData.cellphoneGroup" autocomplete="off" class='inp'></el-input>
        </el-form-item>
        <el-form-item label="设备组描述">
            <el-input v-model="addGroupData.groupDescribe" autocomplete="off" height='200'></el-input>
        </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
            <el-button @click="addGroupVisible = false">取 消</el-button>
            <el-button type="primary" @click="addGroupVisible = false">确定添加</el-button>
        </div>
    </el-dialog>
  </div>
</template>
